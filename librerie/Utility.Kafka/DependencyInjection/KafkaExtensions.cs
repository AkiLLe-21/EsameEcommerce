...
public static class KafkaExtensions {
    ...
    /// <summary>
    /// Registra il <see cref="ConsumerService{TKafkaTopicsInput}"/> e il <typeparamref name="TProducerService"/> di tipo <see cref="AbstractProducerService{TKafkaTopicsOutput}"/>
    /// </summary>
    ...
    public static IServiceCollection AddKafkaServices<TKafkaTopicsInput, TKafkaTopicsOutput, TMessageHandlerFactory, TProducerService>(
        ...
        where TProducerService : AbstractProducerService<TKafkaTopicsOutput>
    {
    ...
    /// <summary>
    /// Registra il <see cref="ConsumerService{TKafkaTopicsInput}"/> e il <typeparamref name="TProducerService"/> di tipo <see cref="AbstractProducerServiceWithSubscription"/>
    /// </summary>
    /// <typeparam name="TKafkaTopicsInput"></typeparam>
    /// <typeparam name="TKafkaTopicsOutput"></typeparam>
    /// <typeparam name="TMessageHandlerFactory"></typeparam>
    ...
    public static IServiceCollection AddKafkaServicesWithSubscription<TKafkaTopicsInput, TKafkaTopicsOutput, TMessageHandlerFactory, TProducerService>(
        ...
        where TKafkaTopicsOutput : class, IKafkaTopics
        where TMessageHandlerFactory : class, IMessageHandlerFactory<string, string>
        where TProducerService : AbstractProducerServiceWithSubscription
    {
    ...
    /// <summary>
    /// Registra il <typeparamref name="TProducerService"/> di tipo <see cref="AbstractProducerService{TKafkaTopicsOutput}"/>
    /// </summary>
    /// <typeparam name="TKafkaTopicsOutput"></typeparam>
    /// <typeparam name="TProducerService"></typeparam>
    /// <param name="services"></param>
    ...
    /// <summary>
    /// Registra il <typeparamref name="TProducerService"/> di tipo <see cref="AbstractProducerServiceWithSubscription"/>
    /// </summary>
    /// <typeparam name="TKafkaTopicsOutput"></typeparam>
    /// <typeparam name="TProducerService"></typeparam>
    /// <param name="services"></param>
